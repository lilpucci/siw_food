...
import static it.uniroma3.siwfood.siw_food.model.Credentials.ADMIN;
import static it.uniroma3.siwfood.siw_food.model.Credentials.UTENTE_REGISTRATO;
...
public class AuthConfiguration {
    ...
    protected SecurityFilterChain configure(final HttpSecurity httpSecurity)
        ...
        httpSecurity
                ...
                .requestMatchers(HttpMethod.GET,"/chef/**").hasAnyAuthority(UTENTE_REGISTRATO, ADMIN)
                .requestMatchers(HttpMethod.POST,"/chef/**").hasAnyAuthority(UTENTE_REGISTRATO, ADMIN)
